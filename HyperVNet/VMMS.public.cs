...
namespace HyperV
{
    ...
    public partial class VMMS : IDisposable
    {
        ...
        public VMMS(string host)
        {
            ...
            virtualizationScope = new ManagementScope($@"\\{host}\root\virtualization\v2");
            // RSS: need to connect to computer, even if local -- UPDATE: didn't change anything
            virtualizationScope.Connect();
        ...
        public string CreateVirtualMachine(VirtualMachineDefinition virtualMachineDefinition)
        {
            //==================================================================================
            ...
            var vmName = virtualMachine.Properties["Name"].Value.ToString();
